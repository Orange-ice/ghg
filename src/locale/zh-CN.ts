...
export default {
  ...
  'navbar.workbench': '工作台',
  'navbar.feedback': '告诉我们您对产品的',
  'navbar.feedbackAdvice': '意见建议',
  'navbar.contactService': '联系客服',
  'navbar.servicePhone': '热线电话',
  'navbar.wechatCode': '微信扫码 联系客服',
  'navbar.helpcenter': '帮助中心',
  'navbar.messageCenter': '消息中心',
  'navbar.message': '消息通知',
  'navbar.historyMsg': '历史消息',
  'navbar.allRead': '全部已读',
  'navbar.noMsg': '没有更多消息了',
  'navbar.noRecentMsg': '近3个月未收到消息',
  'navbar.language': '语言',
  'navbar.org': '企业信息',
  'navbar.usercenter': '个人中心',
  'navbar.logout': '退出登录',
  'navbar.name.note': '日志管理',
